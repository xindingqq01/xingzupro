<%@ Page Title="" Language="C#" MasterPageFile="~/manage/MasterPage.master" AutoEventWireup="true" CodeFile="Services.aspx.cs" Inherits="manage_Services" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="rightBigTitle"><asp:Label ID="lblBigtitle" runat="server" Text="服务/Services"></asp:Label>
...
<table class="TableList">
                        ...
                        <tr>
                            <td class="FirstCol">
                                <asp:Label ID="lblsProductCategoryNameCN" runat="server" Text="服务(中文)"></asp:Label>
                            </td>
                            <td class="SecondCol">
                        ...
                        <tr>
                            <td class="FirstCol">
                                <asp:Label ID="lblsProductCategoryNameEN" runat="server" Text="服务(英文)"></asp:Label>
                            </td>
                            <td class="SecondCol">
