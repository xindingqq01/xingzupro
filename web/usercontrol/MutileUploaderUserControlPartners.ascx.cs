...
public partial class usercontrol_MutileUploaderUserControlPartners : System.Web.UI.UserControl
{
        ...
        for (int i = 0; i < postedFiles.Count; i++)
        {
            if (postedFiles[i].ContentLength > 0)
            {
                ...
                if (sSaveFolderPath != "")
                    ...
                    basepath = "~/PartnersUpload" + "/" + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() +
                        DateTime.Now.Day.ToString() + DateTime.Now.Hour.ToString() + DateTime.Now.Minute.ToString() +
                        DateTime.Now.Second.ToString() + "/";
